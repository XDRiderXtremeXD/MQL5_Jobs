...
public:
   ...
   virtual bool      Create(const long chart,const string name,const int subwin,const int x1,const int y1,const int x2,const int y2,int TP_,int SL_,double Volumen_,int Posiciones_,int MagicNumber_,bool SoloBot,
                            bool confirmacion,color colorBuy,color colorSell,color colorTP,color colorSL,color colorPositivas,color colorNegativas,color colorTodas,int letrasSize);
   //--- chart event handler
...
bool CControlsDialog::Create(const long chart,const string name,const int subwin,const int x1_,const int y1_,const int x2_,const int y2_,int TP_,int SL_,double Volumen_,int Posiciones_,int MagicNumber_,bool SoloBot,bool confirmacion
                             ,color colorBuy,color colorSell,color colorTP,color colorSL,color colorPositivas,color colorNegativas,color colorTodas,int letrasSize)
  {
   ...
   if(GlobalVariableCheck(string(ChartID())+" X ControlPanel") && GlobalVariableCheck(string(ChartID())+" Y ControlPanel"))
     {
      int x=(int)GlobalVariableGet(string(ChartID())+" X ControlPanel");
      int y=(int)GlobalVariableGet(string(ChartID())+" Y ControlPanel");
      m_norm_rect.Move(x,y);
      m_min_rect.Move(x,y);
      Move(x,y);
      ChartRedraw();
     }
...
//--- create dependent controls
   ...
   m_label_Simbolo.FontSize(letrasSize);
// m_label_Simbolo.Color(clrBlue);
   ...
   m_label_Total.FontSize(letrasSize);
//m_label_Total.Color(clrBlue);
   ...
   m_label_LVolumen.FontSize(letrasSize);
   ...
   m_edit_NVolumen.FontSize(letrasSize);
   ...
   m_label_LPos.FontSize(letrasSize);
   ...
   m_edit_NPos.FontSize(letrasSize);
   ...
   m_label_LStopLoss.FontSize(letrasSize);
   ...
   m_edit_NStopLoss.FontSize(letrasSize);
   ...
   m_label_LTakeProfit.FontSize(letrasSize);
   ...
   m_edit_NTakeProfit.FontSize(letrasSize);
   ...
   m_button_BotonBUY.FontSize(letrasSize);
   ...
   m_button_BotonSELL.FontSize(letrasSize);
   ...
   m_button_ModificarSL.FontSize(letrasSize);
...
//m_button_ModificarSL.Color(clrMagenta);
   ...
   m_button_ModificarTP.FontSize(letrasSize);
...
// m_button_ModificarTP.Color(clrSteelBlue);
   ...
   m_button_CerrarPositivas.FontSize(letrasSize);
   ...
   m_button_CerrarNegativas.FontSize(letrasSize);
   ...
   m_button_CerrarTodo.FontSize(letrasSize);
...
//|                                                                  |
//+------------------------------------------------------------------+
bool CControlsDialog::OnDialogDragEnd()
  {
   CAppDialog::OnDialogDragEnd();

   if(m_minimized)
      m_norm_rect.Move(Left(),Top());
   else
      m_min_rect.Move(Left(),Top());

   GlobalVariableSet(string(ChartID())+" X ControlPanel",Left());
   GlobalVariableSet(string(ChartID())+" Y ControlPanel",Top());
