...
void OnTick()
  {
   ...
   if( Rates[1].close>Bollinger_1_Buffer_UP[1] && KlingerBuffer[1]>Bollinger_Klinger_Buffer_UP[1] && ADXBuffer[1]>Bollinger_ADX_Buffer_UP[1] && ADXBuffer[2]<Bollinger_ADX_Buffer_UP[2] &&  Bollinger_ForceIndex_Buffer_UP[1]<ForceIndexBuffer[1] && Buy==0 && Rates[1].close>Rates[1].open)
     {
   ...
   if(Rates[1].close<Bollinger_1_Buffer_DN[1] && KlingerBuffer[1]<Bollinger_Klinger_Buffer_DN[1] && ADXBuffer[1]>Bollinger_ADX_Buffer_UP[1] && ADXBuffer[2]<Bollinger_ADX_Buffer_UP[2]  && Bollinger_ForceIndex_Buffer_DN[1]>ForceIndexBuffer[1]  && Sell==0 && Rates[1].close<Rates[1].open)
     {
