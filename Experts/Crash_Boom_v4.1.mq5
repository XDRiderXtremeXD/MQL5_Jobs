...
int OnInit()
  {
   ...
   if(Entrar_Barra>Entrar_Barra_Contraria)Entrar_Barra_Rates=Entrar_Barra;
   else Entrar_Barra_Rates=Entrar_Barra_Contraria;
         ...
         if(Modo_Operacion==UP)
           {
            ...
            if(Condicion && Maximas_Operaciones_Normales>OrdenesNormales)
              {
         ...
         if(Modo_Operacion==DOWN)
           {
            ...
            if(Condicion && OrdenesNormales<Maximas_Operaciones_Normales)
              {
               ...
               if(SellTradeBool==false)Print("Entrada ", Bid," SL=",SL_);
              }
               ...
               if(Habilitar_Operaciones_Contrarias && OrdenesContrarias<Maximas_Operaciones_Contrarias)
                 {
                  ...
                  if(BuyTradeBool==false)Print("Entrada ", Ask," SL=",SL_);
                 }
              }
           }
        }
