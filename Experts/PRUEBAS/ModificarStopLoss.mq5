...
//+------------------------------------------------------------------+
//--- inputs for expert
input string             Expert_Title         ="ModificarStopLoss"; // Document name
ulong                    Expert_MagicNumber   =11398;               //
...
input int                Signal_MA_PeriodMA   =50;                  // Moving Average(10,0,...) Period of averaging
