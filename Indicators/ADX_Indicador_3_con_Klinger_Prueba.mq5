   ...
   for(int shift=Start; shift<rates_total; shift++)
     {
      ...
      if(Rates[1].open<Bollinger_1_Buffer_UP[2] && Rates[1].close>Bollinger_1_Buffer_UP[2] && Rates[1].close>Bollinger_2_Buffer_UP[2]
         ...
         &&  ADXBuffer[0]>ADXBuffer[1] && ADXBuffer[0]>ADXBuffer[2] && ADXBuffer[0]>ADXBuffer[3] && Rates[1].close>Rates[1].open)
        {
      ...
      if(Buy_Tiempo>time[shift] && Buy_Tiempo!=0 && KlingerBuffer[1]>Bollinger_Klinger_Buffer_BASE[1] && KlingerBuffer[2]<Bollinger_Klinger_Buffer_BASE[2]
         &&  Gator_Oscilator_Buffer_UP[3]<Gator_Oscilator_Buffer_UP[2] && Gator_Oscilator_Buffer_UP[2]<Gator_Oscilator_Buffer_UP[1])
        {
      ...
      if(Sell_Tiempo>time[shift] && Sell_Tiempo!=0 && KlingerBuffer[1]<Bollinger_Klinger_Buffer_BASE[1] && KlingerBuffer[2]>Bollinger_Klinger_Buffer_BASE[2]
         &&  Gator_Oscilator_Buffer_UP[3]<Gator_Oscilator_Buffer_UP[2] && Gator_Oscilator_Buffer_UP[2]<Gator_Oscilator_Buffer_UP[1])
        {
         CumOffset = CumOffset+IncOffset;
