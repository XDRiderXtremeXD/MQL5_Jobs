...
int OnCalculate(const int rates_total,
                ...
                const int &spread[])
  {
   ...
   &&  ADXBuffer[0]>ADXBuffer[1] && ADXBuffer[0]>ADXBuffer[2] && ADXBuffer[0]>ADXBuffer[3] && Rates[1].close>Rates[1].open && KlingerBuffer[0]>0 && KlingerBuffer[1]>0 && KlingerBuffer[2]>0 && KlingerBuffer[3]>0 && KlingerBuffer[0]>KlingerBuffer[1] && KlingerBuffer[1]>KlingerBuffer[2] && KlingerBuffer[2]>KlingerBuffer[3])
     {
