...
int OnCalculate(const int rates_total,
                ...
                const int &spread[])
  {
   ...
   if( Divergencia_Puntos_1_Buffer_UP[2]!=EMPTY_VALUE && Divergencia_Puntos_2_Buffer_UP[2]!=EMPTY_VALUE && Divergencia_Puntos_3_Buffer_UP[2]!=EMPTY_VALUE && Divergencia_Puntos_4_Buffer_UP[2]!=EMPTY_VALUE && Divergencia_Puntos_1_Buffer_DN[2]!=EMPTY_VALUE && Divergencia_Puntos_2_Buffer_DN[2]!=EMPTY_VALUE && Divergencia_Puntos_3_Buffer_DN[2]!=EMPTY_VALUE && Divergencia_Puntos_4_Buffer_DN[2]!=EMPTY_VALUE && Bollinger_2_Buffer_DN[2]<Bollinger_1_Buffer_DN[2])
     {
    ...
    if(Divergencia_Puntos_1_Buffer_UP[2]!=EMPTY_VALUE && Divergencia_Puntos_2_Buffer_UP[2]!=EMPTY_VALUE && Divergencia_Puntos_3_Buffer_UP[2]!=EMPTY_VALUE && Divergencia_Puntos_4_Buffer_UP[2]!=EMPTY_VALUE && Divergencia_Puntos_1_Buffer_DN[2]!=EMPTY_VALUE && Divergencia_Puntos_2_Buffer_DN[2]!=EMPTY_VALUE && Divergencia_Puntos_3_Buffer_DN[2]!=EMPTY_VALUE && Divergencia_Puntos_4_Buffer_DN[2]!=EMPTY_VALUE && Bollinger_2_Buffer_UP[2]>Bollinger_1_Buffer_UP[2])
     {
      bool AlertaCondicion1=true;
      for(int j=1;j<36;j++){
      if(EMA_Buffer_Alligator[j]<Bollinger_1_Buffer_Central[j]){
