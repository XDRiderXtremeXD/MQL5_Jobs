...
input string Settings_Bollinger_ADX_2="***Settings_Bollinger_ADX_2***";
input int Bollinger_ADX_2_Periodo=20;
input int Bollinger_ADX_2_Shift=0;
input int Bollinger_ADX_2_Desviation=2;
...
int OnInit()
  {
   ...
   Bollinger_ADX_2=iBands(Symbol(),PERIOD_CURRENT,Bollinger_ADX_2_Periodo,Bollinger_ADX_2_Shift,Bollinger_ADX_2_Desviation,ADX_2);
...
int OnCalculate(const int rates_total,
                ...
                const int &spread[])
  {
   ...
   CopyBuffer(ADX_2,0,rates_total-1-shift,45,ADX_2_Buffer);
   CopyBuffer(Bollinger_ADX_2,1,rates_total-1-shift,45,Bollinger_ADX_2_Buffer_UP);
   ...
   if( Divergencia_Puntos_1_Buffer_DN[2]!=EMPTY_VALUE && Divergencia_Puntos_2_Buffer_DN[2]!=EMPTY_VALUE && Divergencia_Puntos_3_Buffer_DN[2]!=EMPTY_VALUE && Divergencia_Puntos_4_Buffer_DN[2]!=EMPTY_VALUE && Bollinger_2_Buffer_DN[2]<Bollinger_1_Buffer_DN[2] &&  Rates[1].close>Rates[2].close && Rates[2].close>Rates[3].close &&  CCIBuffer[0]>CCIBuffer[1] && CCIBuffer[1]>CCIBuffer[2])
     {
      ...
      for(int j=3;j<40;j++){
      if(ADX_2_Buffer[j]>Bollinger_ADX_2_Buffer_UP[j] && ADX_2_Buffer[j+1]>Bollinger_ADX_2_Buffer_UP[j+1] && ADX_2_Buffer[j+2]>Bollinger_ADX_2_Buffer_UP[j+2] )
