   ...
   for(int shift=Start; shift<rates_total; shift++)
     {
      ...
      if(Buy_Tiempo>time[shift] && SARBuffer[2]>=Rates[2].high && SARBuffer[1]<=Rates[1].low && Buy_Tiempo!=0
      ...
      if(Sell_Tiempo>time[shift] && SARBuffer[1]>=Rates[1].high && SARBuffer[2]<=Rates[2].low && Sell_Tiempo!=0
